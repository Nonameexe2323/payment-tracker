      ...
      <div className="max-w-md w-full" style={{ animation: 'fadeInUp 0.4s ease-out both' }}>
        <div className="panel p-8 sm:p-10 text-center relative overflow-hidden">
          ...
          <div className="inline-flex items-center justify-center mb-6 relative">
            <div className="w-24 h-24 rounded-2xl overflow-hidden shadow-xl shadow-[var(--accent-blue-glow)] border-2 border-white/40 relative z-10 transform transition-transform hover:scale-105 duration-200 bg-[var(--stat-bg)]">
              <img
                src="/logo.jpg"
          ...
          {/* Contact Channels */}
          <div className="mt-8 pt-6 border-t border-[var(--border-soft)] text-left">
            <h2 className="text-xs font-bold text-[var(--text-muted)] uppercase tracking-wider mb-3.5 text-center flex items-center justify-center gap-1.5">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              ...
              <a
                ...
                className="flex items-center gap-2.5 p-2.5 rounded-xl border border-[var(--border-soft)] bg-[var(--stat-bg)] hover:bg-[#1877F2]/10 hover:border-[#1877F2]/40 transition-all group"
              >
                <div className="w-8 h-8 rounded-lg bg-[#1877F2] flex items-center justify-center text-white shrink-0 group-hover:scale-105 transition-transform shadow-sm">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </div>
                <div className="min-w-0 text-left">
                  <div className="text-xs font-bold text-[var(--text-primary)] group-hover:text-[#1877F2] transition-colors truncate">Facebook</div>
                  <div className="text-[10px] text-[var(--text-muted)] truncate">เพจหลักร้านค้า</div>
                </div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 p-2.5 rounded-xl border border-[var(--border-soft)] bg-[var(--stat-bg)] hover:bg-black/10 dark:hover:bg-white/10 hover:border-pink-500/40 transition-all group"
              >
                <div className="w-8 h-8 rounded-lg bg-black text-white flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform shadow-sm border border-white/20">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <div className="min-w-0 text-left">
                  <div className="text-xs font-bold text-[var(--text-primary)] group-hover:text-pink-500 transition-colors truncate">TikTok</div>
                  <div className="text-[10px] text-[var(--text-muted)] truncate">ติดตามผลงาน</div>
                </div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 p-2.5 rounded-xl border border-[var(--border-soft)] bg-[var(--stat-bg)] hover:bg-[#5865F2]/10 hover:border-[#5865F2]/40 transition-all group"
              >
                <div className="w-8 h-8 rounded-lg bg-[#5865F2] flex items-center justify-center text-white shrink-0 group-hover:scale-105 transition-transform shadow-sm">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <div className="min-w-0 text-left">
                  <div className="text-xs font-bold text-[var(--text-primary)] group-hover:text-[#5865F2] transition-colors truncate">Discord</div>
                  <div className="text-[10px] text-[var(--text-muted)] truncate">ชุมชนดิสคอร์ด</div>
                </div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 p-2.5 rounded-xl border border-[var(--border-soft)] bg-[var(--stat-bg)] hover:bg-[#00B900]/10 hover:border-[#00B900]/40 transition-all group"
              >
                <div className="w-8 h-8 rounded-lg bg-[#00B900] flex items-center justify-center text-white shrink-0 group-hover:scale-105 transition-transform shadow-sm">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <div className="min-w-0 text-left">
                  <div className="text-xs font-bold text-[var(--text-primary)] group-hover:text-[#00B900] transition-colors truncate">LINE</div>
                  <div className="text-[10px] text-[var(--text-muted)] truncate">ติดต่อแอดมิน</div>
                </div>
              </a>
            </div>
          </div>
          ...
          {/* Footer info */}
          <div className="mt-6 pt-5 border-t border-[var(--border-soft)] text-center">
            <p className="text-xs text-[var(--text-muted)] font-medium flex items-center justify-center gap-1.5">
              <span>💖</span> Jiksaw Shop • บริการขายไอดีเกมอันดับ 1
            </p>
          </div>
        </div>
      </div>
